...
//Appointment date
let appointmentSelectedDate = new Date(selectedDate).toISOString().slice(0, 10);
            const rawData = await fetch(`/appointments/bookAppointment`, {
                method: 'POST',
                body: JSON.stringify({
                    "doctorId": id,
                    ...
                    "appointmentDate": appointmentSelectedDate,
                    "timeSlot": timeSlot,
